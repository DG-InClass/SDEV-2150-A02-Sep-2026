...
console.log(list, output, btnRun, btnClear);
...
const formatResult = (label, value) => `${label} = <u>${value}</u>`;
...
addMessage('This message was constructed with createElement');
...
btnAdd.addEventListener('click', () => {
    ...
    if(title) {
        tasks.push( { title, done: false }); // we have a short-hand form
